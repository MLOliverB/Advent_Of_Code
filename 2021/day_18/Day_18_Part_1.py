...
result = input_number_strings[0]
for i in range(1, len(input_number_strings)):
    # Form a pair of operands (sum)
    sum = "[{},{}]".format(result, input_number_strings[i])
...
print("Result is {}\nwith magnitude {}".format(result, magnitude))